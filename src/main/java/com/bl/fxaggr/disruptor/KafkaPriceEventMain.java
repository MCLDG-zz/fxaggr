...
import com.bl.fxaggr.util.KafkaMessageConsumer;
...
public class KafkaPriceEventMain extends Thread {
    ...
    public static void main(String[] args) throws Exception {
        ...
        KafkaPriceEventGenerator priceEventGenerator = new KafkaPriceEventGenerator(ringBuffer);
        KafkaMessageConsumer kafkaMessageConsumer = new KafkaMessageConsumer(priceEventGenerator);
